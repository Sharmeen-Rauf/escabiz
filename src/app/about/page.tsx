        ...
        <section className="relative w-full bg-gradient-to-b from-white via-gray-50/30 to-white py-8 md:py-10 lg:py-12 overflow-hidden">
          ...
          <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
              {/* Card 1: Our Clients */}
              <div className="relative bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden group hover:shadow-xl transition-all duration-300">
                <div className="p-5">
                  <div className="w-12 h-12 bg-[#1c75c0]/10 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                ...
                <div className="h-40 bg-gradient-to-br from-gray-100 to-gray-50 relative overflow-hidden">
                  <Image src="/1.jpg" alt="Our Clients" fill className="object-cover opacity-60" />
                </div>
              </div>
              ...
              <div className="relative bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden group hover:shadow-xl transition-all duration-300">
                ...
                <div className="h-40 bg-gradient-to-br from-gray-100 to-gray-50 relative overflow-hidden">
                  <Image src="/2.jpg" alt="Our Work" fill className="object-cover opacity-60" />
                </div>
              </div>
              ...
              <div className="relative bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden group hover:shadow-xl transition-all duration-300">
                ...
                <div className="h-40 bg-gradient-to-br from-gray-100 to-gray-50 relative overflow-hidden">
                  <Image src="/3.jpg" alt="Our Team" fill className="object-cover opacity-60" />
                </div>
              </div>
              ...
              <div className="relative bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden group hover:shadow-xl transition-all duration-300">
                ...
                <div className="h-40 bg-gradient-to-br from-gray-100 to-gray-50 relative overflow-hidden">
                  <Image src="/4.jpg" alt="Project Timeline" fill className="object-cover opacity-60" />
                </div>
              </div>
            </div>
          </div>
