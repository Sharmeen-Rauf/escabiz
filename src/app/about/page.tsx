        ...
        <section className="relative w-full bg-white py-8 md:py-10 lg:py-12 overflow-hidden reveal">
          <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
              {/* Card 1: Our Clients */}
              <div className="relative bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden group hover:shadow-xl hover:-translate-y-1 hover:border-[#1c75c0] transition-all duration-300 reveal flex flex-col" style={{ animationDelay: '0.1s' }} data-aos="fade-up">
                <div className="p-6 flex flex-col items-center text-center gap-3 flex-1">
                  ...
                  <h5 className="text-base md:text-lg font-semibold text-[#6f7074] leading-tight capitalize">
                    Our Clients
                  </h5>
              ...
              {/* Card 2: Our Work */}
              <div className="relative bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden group hover:shadow-xl hover:-translate-y-1 hover:border-[#1c75c0] transition-all duration-300 reveal flex flex-col" style={{ animationDelay: '0.2s' }} data-aos="fade-up" data-aos-delay="100">
                <div className="p-6 flex flex-col items-center text-center gap-3 flex-1">
              ...
              {/* Card 3: Our Team */}
              <div className="relative bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden group hover:shadow-xl hover:-translate-y-1 hover:border-[#1c75c0] transition-all duration-300 reveal flex flex-col" style={{ animationDelay: '0.3s' }} data-aos="fade-up" data-aos-delay="200">
                <div className="p-6 flex flex-col items-center text-center gap-3 flex-1">
              ...
              <div className="relative bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden group hover:shadow-xl hover:-translate-y-1 hover:border-[#1c75c0] transition-all duration-300 reveal flex flex-col" style={{ animationDelay: '0.4s' }} data-aos="fade-up" data-aos-delay="300">
                <div className="p-6 flex flex-col items-center text-center gap-3 flex-1">
