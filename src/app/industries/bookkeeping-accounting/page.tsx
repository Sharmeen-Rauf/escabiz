      ...
      <main className="relative">
        ...
        <section className="w-full bg-white py-10 md:py-14 lg:py-16">
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold text-[#6f7074] leading-tight mb-3 text-center" data-aos="fade-up">
              Real Results: Bookkeeping & Accounting Case Studies
            </h3>
            <p className="text-xs sm:text-xs md:text-sm text-[#a9a9a9] leading-tight font-normal text-center max-w-3xl mx-auto mb-10" data-aos="fade-up" data-aos-delay="100">
              Here's how we've helped bookkeeping and accounting firms grow their client base and achieve faster deal cycles.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
              {[
                ...
                {
                  image: '/fintrack.jpg',
                  company: 'FinTrack Services',
                  description: 'FinTrack provides tax preparation for small businesses. EscaBiz helped them reach owners in logistics and retail industries.',
                  stats: {
                    calls: '8,912',
                    decisionMakers: '271',
                    followUps: '82',
                ...
                {
                  image: '/accupay.jpg',
                  company: 'AccuBooks Advisory',
                  description: 'AccuBooks delivers outsourced accounting and payroll services. With EscaBiz, they achieved faster deal cycles.',
                  stats: {
                    calls: '7,586',
                    decisionMakers: '232',
                    followUps: '58',
        ...
        <section className="relative w-full min-h-[600px] md:min-h-[650px] lg:min-h-[600px] flex items-center overflow-hidden bg-slate-700">
          <div
            ...
            style={{ backgroundImage: 'url(/Accounting.jpg)' }}
          ></div>
          ...
          <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-24">
            <div className="max-w-2xl mx-auto text-center reveal-show" style={{ opacity: 1, transform: 'translateY(0)' }}>
              <h1
                ...
                data-aos="fade-up"
              >
                Bookkeeping & Accounting Lead Generation Solutions
              </h1>
              <p
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className="flex flex-col" data-aos="fade-right">
                <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold text-[#6f7074] leading-tight mb-4">
                  Growing Your Bookkeeping & Accounting Client Base
                </h2>
                ...
                >
                  <span className="relative z-10 flex items-center">
                    View Details for Bookkeeping & Accounting
                    <svg className="ml-2 w-5 h-5 transition-transform duration-300 group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                    </svg>
                  </span>
          ...
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-10" data-aos="fade-up">
              <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold text-[#6f7074] leading-tight mb-4">
                Why Choose EscaBiz for Bookkeeping & Accounting Lead Generation?
              </h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
              {[
                {
                  title: 'SMB Focus',
                  description: 'We connect you with SMBs in need of financial expertise and reliable bookkeeping services.',
                },
                {
                  title: 'Lead Quality',
                  description: 'Our campaigns target decision-makers looking for trusted partners to handle their finances.',
                },
                {
                  title: 'Improved Retention',
                  description: 'We ensure your services reach those who truly need them, improving close rates and long-term client retention.',
                },
              ].map((item, index) => (
                <div
                  key={index}
          ...
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-gradient-to-br from-blue-50/30 to-blue-50/10 rounded-2xl shadow-lg shadow-blue-100/50 p-6 md:p-8 lg:p-10 text-center">
              ...
              <p className="text-sm md:text-base text-[#6f7074] leading-relaxed max-w-2xl mx-auto mb-6" data-aos="fade-up" data-aos-delay="100">
                Let EscaBiz help you connect with SMBs in need of financial expertise and grow your bookkeeping and accounting client base.
              </p>
              <Link
                href="/lets-talk"
