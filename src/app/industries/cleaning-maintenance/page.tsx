      ...
      <main className="relative">
          ...
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
              {[
                {
                  image: '/bayarea.jpg',
                  company: 'Bay Area Janitorial Force Inc.',
                  description: 'Bay Area Janitorial is a trusted cleaning company serving the San Francisco Bay Area for over 20 years. They deliver high-quality residential and commercial cleaning services.',
                  stats: {
                    calls: '17,358',
                    decisionMakers: '359',
                    followUps: '117',
                ...
                {
                  image: '/cleanpro.jpg',
                  company: 'CleanPro Maintenance Group',
                  description: 'CleanPro provides eco-friendly cleaning for hospitals and schools. EscaBiz helped them land key B2B contracts by identifying facility directors across California.',
                  stats: {
                    calls: '12,781',
                    decisionMakers: '281',
                    followUps: '97',
                ...
                {
                  image: '/metroclean.jpg',
                  company: 'MetroClean USA',
                  description: 'MetroClean specializes in industrial and commercial cleaning. After partnering with EscaBiz, they achieved record-levels of lead engagement from manufacturing companies.',
                  stats: {
                    calls: '14,529',
                    decisionMakers: '317',
                    followUps: '85',
        ...
        <section className="relative w-full min-h-[600px] md:min-h-[650px] lg:min-h-[600px] flex items-center overflow-hidden bg-slate-700">
          <div
            ...
            style={{ backgroundImage: 'url(/Cleaning%20(1).jpg)' }}
          ></div>
          ...
          <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-24">
            <div className="max-w-2xl mx-auto text-center reveal-show" style={{ opacity: 1, transform: 'translateY(0)' }}>
              <h1
                ...
                data-aos="fade-up"
              >
                Cleaning & Maintenance Lead Generation Solutions
              </h1>
              <p
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className="flex flex-col" data-aos="fade-right">
                <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold text-[#6f7074] leading-tight mb-4">
                  Connecting You with Property Managers & Facility Directors
                </h2>
                ...
                >
                  <span className="relative z-10 flex items-center">
                    View Details for Cleaning & Maintenance
                    <svg className="ml-2 w-5 h-5 transition-transform duration-300 group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                    </svg>
                  </span>
          ...
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-10" data-aos="fade-up">
              <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold text-[#6f7074] leading-tight mb-4">
                Why Choose EscaBiz for Cleaning & Maintenance Lead Generation?
              </h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
              {[
                {
                  title: 'Targeted B2B Contracts',
                  description: 'We connect you with property managers, facility directors, and corporate clients actively seeking service partners.',
                },
                {
                  title: 'Operational Strength Highlighting',
                  description: 'Our strategies showcase your certifications and service reliability to attract high-value clients.',
                },
                {
                  title: 'Consistent Client Acquisition',
                  description: 'Steady flow of qualified leads to help you grow your cleaning and maintenance business.',
                },
              ].map((item, index) => (
                <div
                  key={index}
          ...
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-gradient-to-br from-blue-50/30 to-blue-50/10 rounded-2xl shadow-lg shadow-blue-100/50 p-6 md:p-8 lg:p-10 text-center">
              <h3 className="text-xl sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#6f7074] leading-tight mb-4" data-aos="fade-up">
                Ready to Secure More B2B Contracts?
              </h3>
              <p className="text-sm md:text-base text-[#6f7074] leading-relaxed max-w-2xl mx-auto mb-6" data-aos="fade-up" data-aos-delay="100">
                Let EscaBiz help you connect with property managers and facility directors who need reliable cleaning and maintenance partners.
              </p>
              <Link
                href="/lets-talk"
