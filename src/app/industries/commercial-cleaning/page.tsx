        ...
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-5">
            {[
              ...
              >
                <div className="w-12 h-12 flex items-center justify-center rounded-md bg-[#1c75c0]/10 group-hover:bg-white/15 transition-all duration-300">
                  {card.icon === "dollar" && (
                    <svg className="w-7 h-7 text-[#1c75c0] group-hover:text-white transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
