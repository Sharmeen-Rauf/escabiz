        ...
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-5">
            {[
              ...
              <div
                key={i}
                className="group bg-white rounded-lg border border-gray-200 transition-all duration-300 p-5 flex items-start gap-4 md:hover:-translate-y-1 md:hover:bg-[#1c75c0] md:hover:border-[#1c75c0] shadow-sm md:hover:shadow-xl"
                data-aos="zoom-in"
                data-aos-delay={`${(i + 1) * 100 + 400}`}
              >
                <div className="w-10 h-10 flex items-center justify-center rounded-md bg-[#1c75c0]/10 md:group-hover:bg-white/15 transition-all duration-300">
                  {card.icon === "dollar" && (
                    <svg className="w-5 h-5 text-[#1c75c0] md:group-hover:text-white transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex-1">
                  <p className="text-xs sm:text-xs md:text-sm text-[#a9a9a9] md:group-hover:text-white leading-tight font-normal">
                    {card.front}
                  </p>
                </div>
              </div>
