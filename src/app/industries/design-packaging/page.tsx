...
export default function DesignPackagingPage() {
  useEffect(() => {
        ...
        <section className="w-full bg-white py-10 md:py-14 lg:py-16">
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold text-[#6f7074] leading-tight mb-3 text-center" data-aos="fade-up">
              Real Results: Design & Packaging Case Studies
            </h3>
            <p className="text-xs sm:text-xs md:text-sm text-[#a9a9a9] leading-tight font-normal text-center max-w-3xl mx-auto mb-10" data-aos="fade-up" data-aos-delay="100">
              Here's how we've helped design and packaging agencies scale project requests and improve their B2B deal flow.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
              {[
                {
                  image: '/dot.jpg',
                  company: 'Dot Matrix Design Group',
                  description: 'Dot Matrix offers collaborative design for startups and corporations. EscaBiz helped them scale project requests quickly.',
                  stats: {
                    calls: '8,293',
                    decisionMakers: '143',
                    followUps: '70',
                ...
                {
                  image: '/brandhaus.jpg',
                  company: 'BrandHaus Creative',
                  description: 'BrandHaus focuses on packaging design for retail brands. EscaBiz increased their inbound project volume.',
                  stats: {
                    calls: '6,854',
                    decisionMakers: '125',
                    followUps: '52',
                ...
                },
                {
                  ...
                  description: 'Designify delivers branding and digital visuals for corporate clients. EscaBiz improved their B2B deal flow substantially.',
                  stats: {
                    calls: '7,148',
                    decisionMakers: '132',
                    followUps: '64',
          ...
          <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-24">
            <div className="max-w-2xl mx-auto text-center reveal-show" style={{ opacity: 1, transform: 'translateY(0)' }}>
              <h1
                ...
                data-aos="fade-up"
              >
                Design & Packaging Lead Generation Solutions
              </h1>
              <p
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className="flex flex-col" data-aos="fade-right">
                <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold text-[#6f7074] leading-tight mb-4">
                  Connecting Design Firms with Brands
                </h2>
                ...
                >
                  <span className="relative z-10 flex items-center">
                    View Details for Design & Packaging
                    <svg className="ml-2 w-5 h-5 transition-transform duration-300 group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                    </svg>
                  </span>
          ...
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-10" data-aos="fade-up">
              <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold text-[#6f7074] leading-tight mb-4">
                Why Choose EscaBiz for Design & Packaging Lead Generation?
              </h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
              {[
                {
                  title: 'Creative Agency Connections',
                  description: 'We connect creative agencies and packaging design firms with brands seeking innovative designs.',
                },
                {
                  title: 'Brand Identity Enhancement',
                  description: 'We help you attract eCommerce companies, manufacturers, and startups looking to enhance their brand identity.',
                },
                {
                  title: 'Steady Project Flow',
                  description: 'Our approach ensures steady inquiries, helping your design team stay busy with profitable projects.',
                },
              ].map((item, index) => (
                <div
                  key={index}
          ...
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-gradient-to-br from-blue-50/30 to-blue-50/10 rounded-2xl shadow-lg shadow-blue-100/50 p-6 md:p-8 lg:p-10 text-center">
              ...
              <p className="text-sm md:text-base text-[#6f7074] leading-relaxed max-w-2xl mx-auto mb-6" data-aos="fade-up" data-aos-delay="100">
                Let EscaBiz help you connect with brands seeking innovative, conversion-focused designs and keep your design team busy with profitable projects.
              </p>
              <Link
                href="/lets-talk"
