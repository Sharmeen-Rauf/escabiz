      ...
      <main className="relative">
        ...
        <section className="w-full bg-white py-10 md:py-14 lg:py-16">
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold text-[#6f7074] leading-tight mb-3 text-center" data-aos="fade-up">
              Real Results: Recruitment & Staffing Case Studies
            </h3>
            <p className="text-xs sm:text-xs md:text-sm text-[#a9a9a9] leading-tight font-normal text-center max-w-3xl mx-auto mb-10" data-aos="fade-up" data-aos-delay="100">
              Here's how we've helped recruitment agencies connect with HR directors and expand their client base.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
              {[
                {
                  image: '/miw.jpg',
                  company: 'Mclean Intelligent Workforce',
                  description: 'Mclean Intelligent Workforce (MIW) is a recruitment agency that helps government and corporate clients find skilled professionals. Their focus on specific qualifications makes them a trusted hiring partner.',
                  stats: {
                    calls: '11,487',
                    decisionMakers: '954',
                    followUps: '105',
                ...
                {
                  image: '/talentedge.jpg',
                  company: 'TalentEdge Recruiters',
                  description: 'TalentEdge specializes in tech and healthcare recruitment. With EscaBiz, they expanded into new territories and reached key HR directors looking for specialized talent.',
                  stats: {
                    calls: '8,962',
                    decisionMakers: '613',
                    followUps: '89',
                ...
                {
                  image: '/hireprohealth.jpg',
                  company: 'HirePro Staffing Solutions',
                  description: 'HirePro is a U.S.-based staffing firm that provides both contract and full-time placements. EscaBiz helped them generate consistent weekly meetings with HR leaders across industries.',
                  stats: {
                    calls: '10,324',
                    decisionMakers: '742',
                    followUps: '121',
        ...
        <section className="relative w-full min-h-[600px] md:min-h-[650px] lg:min-h-[600px] flex items-center overflow-hidden bg-slate-700">
          <div
            ...
            style={{ backgroundImage: 'url(/Recurting%20and%20staffing.jpg)' }}
          ></div>
          ...
          <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-24">
            <div className="max-w-2xl mx-auto text-center reveal-show" style={{ opacity: 1, transform: 'translateY(0)' }}>
              <h1
                ...
                data-aos="fade-up"
              >
                Recruitment & Staffing Lead Generation Solutions
              </h1>
              <p
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className="flex flex-col" data-aos="fade-right">
                <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold text-[#6f7074] leading-tight mb-4">
                  Empowering Recruitment & Staffing Companies
                </h2>
                ...
                >
                  <span className="relative z-10 flex items-center">
                    View Details for Recruitment & Staffing
                    <svg className="ml-2 w-5 h-5 transition-transform duration-300 group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                    </svg>
                  </span>
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-lg" data-aos="fade-left">
                <div className="aspect-[4/3] relative w-full">
                  <Image
                    src="/Recurting%20and%20staffing.jpg"
          ...
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-10" data-aos="fade-up">
              <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold text-[#6f7074] leading-tight mb-4">
                Why Choose EscaBiz for Recruitment & Staffing Lead Generation?
              </h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
              {[
                {
                  ...
                  description: 'We connect you with decision-makers actively seeking staffing solutions and talent acquisition partners.',
                },
                {
                  title: 'Multi-Channel Approach',
                  description: 'Combining email, LinkedIn, and personalized follow-ups to maximize your reach and engagement.',
                },
                {
                  title: 'Pre-Qualified Leads',
                  description: 'Only sales-ready, qualified leads reach your team, saving time and improving conversion rates.',
                },
              ].map((item, index) => (
                <div
                  key={index}
          ...
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-gradient-to-br from-blue-50/30 to-blue-50/10 rounded-2xl shadow-lg shadow-blue-100/50 p-6 md:p-8 lg:p-10 text-center">
              ...
              <p className="text-sm md:text-base text-[#6f7074] leading-relaxed max-w-2xl mx-auto mb-6" data-aos="fade-up" data-aos-delay="100">
                Let EscaBiz help you generate consistent, high-quality B2B leads so you can focus on what you do best: placing talent.
              </p>
              <Link
                href="/lets-talk"
