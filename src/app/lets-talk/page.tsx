            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
              ...
              <div className="bg-white rounded-xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="p-6">
                  ...
                  <p className="text-xs sm:text-xs md:text-sm text-[#1c75c0] mb-2"><a href="mailto:info@escabiz.com" className="hover:underline">info@escabiz.com</a></p>
                  <div className="flex items-center gap-2">
                    <svg className="w-4 h-4 text-[#6f7074] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                    <a href="tel:+2143852516" className="text-xs sm:text-xs md:text-sm text-[#6f7074] hover:text-[#1c75c0] transition-colors">(214) 385-2516</a>
                  </div>
                </div>
              </div>
              {/* US */}
              <div className="bg-white rounded-xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <a href="tel:+18557612357" className="text-xs sm:text-xs md:text-sm text-[#6f7074] hover:text-[#1c75c0] transition-colors">(855) 761-2357</a>
                  </div>
                </div>
              </div>
              {/* Pakistan */}
              <div className="bg-white rounded-xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                <div className="relative h-64 w-full overflow-hidden bg-gradient-to-br from-gray-100 to-gray-50">
                  <Image 
                    src="/Mazar-e-Quaid-B-14-08-1024x640.jpg" 
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <a href="tel:+923356661821" className="text-xs sm:text-xs md:text-sm text-[#6f7074] hover:text-[#1c75c0] transition-colors">92 335 6661821</a>
                  </div>
                </div>
              </div>
            </div>
