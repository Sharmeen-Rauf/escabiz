        ...
        <section className="w-full bg-white py-10 md:py-14 lg:py-16 reveal relative overflow-hidden">
          <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-5">
              ...
              <div className="group rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 bg-white flex flex-col">
                ...
                {/* Lower Content Block */}
                <div className="bg-[#1c75c0] p-4 lg:p-5 rounded-b-lg pr-6 lg:pr-8 group-hover:bg-[#1c75c0] transition-all duration-300 flex-1 flex flex-col hover:bg-[#1c75c0]">
                  {/* Icon and Heading Row */}
                  <div className="flex items-start gap-3 mb-3">
                    {/* Icon with Square Background */}
                    <div className="w-10 h-10 bg-[#1a1a1a] rounded flex items-center justify-center flex-shrink-0">
              ...
              <div className="group rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 bg-white flex flex-col">
                ...
                {/* Lower Content Block */}
                <div className="bg-[#6f7074] p-4 lg:p-5 rounded-b-lg pr-6 lg:pr-8 group-hover:bg-[#1c75c0] transition-all duration-300 flex-1 flex flex-col">
                  {/* Icon and Heading Row */}
                  <div className="flex items-start gap-3 mb-3">
                    {/* Icon with Square Background */}
                    <div className="w-10 h-10 bg-[#1a1a1a] rounded flex items-center justify-center flex-shrink-0">
