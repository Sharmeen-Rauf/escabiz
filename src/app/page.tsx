...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* Footer Section */}
      <footer className="w-full relative overflow-hidden" style={{ background: 'linear-gradient(to top left, #0891b2, #06b6d4, #67e8f9, #cffafe)' }}>
        {/* "Let's Talk Business" Tab - Right Side */}
        <div className="absolute right-0 top-1/2 -translate-y-1/2 z-10 hidden lg:block">
          <Link href="/lets-talk" className="flex items-center justify-center h-32 w-12 bg-cyan-600/90 hover:bg-cyan-600 rounded-l-lg shadow-lg transition-all duration-300 group">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-6">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex items-center space-x-3 mb-6">
                <a href="#" className="w-10 h-10 bg-white/30 border border-gray-400/50 rounded-full flex items-center justify-center hover:bg-white/50 transition-colors duration-300">
              ...
              <div className="space-y-2">
                <a href="#" className="block text-sm text-black/80 hover:text-black transition-colors duration-300">
                  Terms & Conditions
                </a>
                <a href="#" className="block text-sm text-black/80 hover:text-black transition-colors duration-300">
                  Privacy Policy
        ...
        <div className="border-t border-cyan-400/30">
          <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <p className="text-sm text-black text-center font-semibold">
              Email: <a href="mailto:info@escabiz.com" className="text-black hover:text-cyan-700 transition-colors duration-300">info@escabiz.com</a>
            </p>
          </div>
        </div>
