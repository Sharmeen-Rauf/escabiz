...
export default function Navbar() {
  ...
  const [isScrolled, setIsScrolled] = useState(pathname !== '/' && pathname !== '/lets-talk' && pathname !== '/about' && pathname !== '/industries/hr-recruiting' && pathname !== '/virtual-staff-augmentation/marketing-vsa' && pathname !== '/b2b-appointment-setup' && pathname !== '/b2b-market-research-agency-escabiz' && pathname !== '/prospect-research-list-management-services-escabiz' && pathname !== '/linkedin-automation-services-escabiz' && pathname !== '/b2b-targeted-marketing-services-escabiz' && pathname !== '/industries/commercial-cleaning');
